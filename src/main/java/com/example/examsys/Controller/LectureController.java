        ...
        return new Callable<ResponseData>() {
            ...
            public ResponseData call() throws Exception {
                ...
                try {
                    ...
                    rsp.setRspData(new LectureDTO(lectureServices.addLecture(lectureDTO)));
                } catch (Exception e) {
                    e.printStackTrace();
                    rsp.setFailed();
        ...
        return new Callable<ResponseData>() {
            ...
            public ResponseData call() throws Exception {
                ...
                try {
                    ...
                    if (lectureDTO.getTeacherID() == Long.parseLong(JwtUtil.getUserId(token)) || JwtUtil.getPower(token) > 2) {
